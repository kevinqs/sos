        ...
        case 13:
         ...
         if (this.results_showing) {
            return this.result_select(evt);
        	 ...
        	 //to be added by Kavitha
        	 $('.searchFormBtns').trigger('click');
         }
         break;
        case 27:
          if (this.results_showing) {
...
//Kavitha
    Chosen.prototype.show_create_option = function(terms) {
      ...
      create_option_html = $('<li class="create-option active-result" value="others:"'+ terms +'>' + terms + '</li>');
...
//@ sourceURL=vcc/chosen.jquery.js